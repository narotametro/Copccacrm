...
export const PricingPage: React.FC = () => {
  ...
  const generatePricingPDF = async () => {
    ...
    const opt = {
      margin: 1,
      filename: 'COPCCA-CRM-Pricing.pdf',
  ...
  const shareViaEmail = async () => {
    ...
    const subject = encodeURIComponent('COPCCA CRM Pricing Information');
    const body = encodeURIComponent('Please find attached the COPCCA CRM pricing information PDF.\n\nBest regards,\nCOPCCA CRM Team');
    window.open(`mailto:?subject=${subject}&body=${body}`);
  };

  const shareViaWhatsApp = async () => {
    await generatePricingPDF();
    const message = encodeURIComponent('Please find the COPCCA CRM pricing information PDF attached. Let me know if you have any questions!\n\nBest regards,\nCOPCCA CRM Team');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
      ...
      <div id="pricing-content" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Header */}
        ...
        {/* Pricing Cards */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch mb-16 pt-8">
          {pricingPlans.map((plan) => (
            <div key={plan.name} className="pdf-page-break">
              <Card
                ...
                <Button
                  ...
                  onClick={() => {
                    if (plan.cta === 'Contact Sales') {
                      window.open('mailto:sales@copcca.com', '_blank');
                    } else {
                      navigate('/register');
                    }
                  }}
