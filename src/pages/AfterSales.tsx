...
const demoTasks: Task[] = [
  ...
  {
    id: '0',
    title: 'Damage compensation to DANGOOD',
    description: 'Process and finalize compensation claim for damaged goods received by DANGOOD customer. Urgent follow-up required.',
    status: 'in-progress',
    priority: 'high',
    assigned_to: 'Claims Team',
    assigned_by: 'Customer Support Manager',
    linked_to: {
      type: 'customer',
      id: '99',
      name: 'DANGOOD Corp'
    ...
    is_overdue: true,
    days_overdue: 33, // Today is Jan 7, 2026
    estimated_hours: 4,
    actual_hours: 2,
    tags: ['urgent', 'claims', 'customer-service'],
    feedback: [
      { id: '1', date: '2025-12-10', user: 'Manager', comment: 'Still waiting for approval from finance team' },
      { id: '2', date: '2025-12-20', user: 'Claims Lead', comment: 'Customer called again - getting frustrated' },
      { id: '3', date: '2026-01-05', user: 'Director', comment: 'ESCALATED: Need to resolve this week!' }
    ]
  },
  {
    id: '1',
    title: 'Follow up on Enterprise CRM deal',
    description: 'Schedule final pricing call with CFO Sarah Johnson',
    status: 'todo',
    priority: 'urgent',
    ...
    linked_to: {
      type: 'deal',
      id: '1',
      name: 'Enterprise CRM License - Acme Corp'
    },
    ...
    estimated_hours: 2,
    actual_hours: 0,
    tags: ['sales', 'high-value', 'enterprise'],
    feedback: [
      { id: '1', date: '2026-01-06', user: 'John Smith', comment: 'Initial contact made, waiting for CFO availability' }
    ]
  },
  {
    id: '2',
    title: 'Analyze Salesforce pricing strategy',
    description: 'Research their latest enterprise pricing and create competitive response',
    status: 'in-progress',
    priority: 'high',
  ...
  {
    id: '3',
    title: 'Send product demo to GlobalTech',
    description: 'Prepare customized demo showing migration features',
    status: 'in-progress',
    priority: 'high',
    ...
    estimated_hours: 3,
    actual_hours: 1.5,
    tags: ['demo', 'customer-success']
  },
  {
    id: '4',
    title: 'Review Q1 Campaign performance',
    description: 'Analyze ROI and prepare optimization recommendations',
    status: 'review',
    priority: 'medium',
  ...
  {
    id: '5',
    title: 'Update COPCCA Mobile features',
    description: 'Add offline mode improvements based on customer feedback',
    status: 'todo',
    priority: 'medium',
    ...
    estimated_hours: 8,
    actual_hours: 0,
    tags: ['product', 'development', 'feedback']
  },
  {
    id: '6',
    title: 'Onboard new enterprise client',
    description: 'Complete setup and initial training for TechFlow Systems',
    status: 'done',
    priority: 'high',
  ...
  {
    id: '7',
    title: 'Fix critical bug in Analytics',
    description: 'Dashboard not loading for some users - priority fix needed',
    status: 'todo',
    priority: 'urgent',
    assigned_to: 'Dev Team',
    assigned_by: 'Support',
