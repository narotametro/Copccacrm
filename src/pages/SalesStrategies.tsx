...
const demoCampaigns: Campaign[] = [
  {
    ...
    status: 'active',
    target_audience: ['SMBs', 'Tech Companies', 'Nigeria', 'Kenya'],
    ...
    ai_score: 92,
    ai_recommendations: [
      'Increase LinkedIn ad spend by 30% - highest conversion',
      'Send emails on Tuesday 10am - 40% better open rate',
      'Add video content - 2x engagement vs images',
    ],
    best_channel: 'LinkedIn',
    best_time: 'Tuesday 10am',
    ab_testing: {
      enabled: true,
      variant_a: 'Free Trial CTA',
      variant_b: 'Book Demo CTA',
      winner: 'A',
    },
    message_subject: '🚀 Launch Special: Get 3 Months Free',
    message_preview: 'Be among the first 100 businesses to experience our AI-powered CRM...',
  },
  {
    id: '2',
    name: 'Enterprise Outreach Campaign',
    status: 'active',
    target_audience: ['Enterprise', 'Finance', 'Healthcare', 'Pan-African'],
    ...
    ai_score: 85,
    ai_recommendations: [
      'Personalize emails with company name - 60% higher response',
      'Target CFOs and CTOs specifically',
    ...
    ab_testing: {
      enabled: true,
      variant_a: 'ROI Calculator CTA',
      variant_b: 'Schedule Consultation CTA',
      winner: null,
    },
    message_subject: 'Enterprise CRM Built for African Markets',
    message_preview: 'See how companies like yours are scaling with COPCCA...',
  },
  {
    id: '3',
    name: 'Holiday Flash Sale',
    status: 'scheduled',
    target_audience: ['All Customers', 'Active Leads'],
    ...
    ai_score: 78,
    ai_recommendations: [
      'Start social media teasers 2 weeks early',
      'Offer tiered discounts - 20%, 30%, 40% throughout campaign',
    ...
    message_subject: '🎄 Holiday Special: Up to 40% Off',
    message_preview: 'Limited time offer! Upgrade your CRM before year-end...',
  },
  {
    id: '4',
    name: 'Customer Success Stories',
    status: 'completed',
    target_audience: ['Prospects', 'Trial Users'],
    ...
    ai_score: 88,
    ai_recommendations: [
      'Replicate this campaign - excellent ROI',
      'Video testimonials performed 3x better than text',
      'Focus on specific industries for better targeting',
    ],
    best_channel: 'Social Media',
    best_time: 'Friday 3pm',
    ab_testing: {
      enabled: true,
      variant_a: 'Video Testimonial',
      variant_b: 'Text Case Study',
      winner: 'A',
    },
    message_subject: 'How Nigerian SMBs 3X Their Sales with COPCCA',
    message_preview: 'Real stories from real businesses...',
  },
];
